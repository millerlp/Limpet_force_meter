...
not functional. No results from the
2016-12-15 trial should be trusted until this is rectified. 



```{r importRawCalib20161213, echo=showcode, caption="Calibration data from 2016-12-13"}
...
```{r importRawCalib20170104, echo=showcode,caption="Calibration data from 2016-01-04"}
...
```{r importRawCalib20170105, echo=showcode,caption="Calibration data from 2017-01-05"}
# Repeat for the next calibration file
...
```{r choosePeaks, eval = FALS, echo=showcode}
...
`Events_picker_output_20180122.csv`. The data in that file next need to be 
...
```{r classifyPeckPush, echo=showcode}
...
events2 = read.csv(paste0(fdir,'Events_picker_output_20180122.csv'))
...
#write.csv(events3, file = 'Events_classified_20180122.csv',row.names=FALSE)

```


```{r summaryTable, eval = FALSE, echo=showcode}

events3 = read.csv(paste0(fdir,'Events_classified_20180122.csv'))
