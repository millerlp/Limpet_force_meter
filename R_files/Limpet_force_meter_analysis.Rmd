...
for (i in 1:length(forcefiles)){
	...
	# Assemble date
	# TODO: The year is coming through wrong for the 2017 calibration dates
...
# each channel to forces in Newtons, and store those data in a list for 
# each event. 
...
temp2 = forces[(timeMatch-100):(timeMatch+100),c('JOY_X_signal','JOY_Y_signal',
				'BEAM_Z_signal')]
